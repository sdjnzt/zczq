...
export const villageList = ref([
  { id: 1, name: '城前村', secretary: '张建国', population: 1250, area: 2800, income: 35 },
  { id: 2, name: '前村', secretary: '李志强', population: 980, area: 2200, income: 28 },
  { id: 3, name: '后村', secretary: '王伟', population: 1100, area: 2500, income: 32 },
  { id: 4, name: '东村', secretary: '赵云', population: 870, area: 1800, income: 21 },
  { id: 5, name: '西村', secretary: '孙磊', population: 1340, area: 3000, income: 40 }
])

// 村民数据
export const residentList = ref([
  { id: 1, name: '张志强', idCard: '370881198503154378', village: '城前村', gender: '男', age: 38, phone: '15865432198', type: 'party' },
  { id: 2, name: '李丽华', idCard: '370881199007123425', village: '前村', gender: '女', age: 33, phone: '13776549821', type: 'normal' },
  { id: 3, name: '王文明', idCard: '370881196805127865', village: '后村', gender: '男', age: 55, phone: '18932156478', type: 'party' },
  { id: 4, name: '赵小丽', idCard: '370881200201087654', village: '东村', gender: '女', age: 21, phone: '13798765432', type: 'normal' },
  { id: 5, name: '孙志远', idCard: '370881197305128907', village: '西村', gender: '男', age: 50, phone: '17865432109', type: 'party' }
])

// 村务公开数据
export const publicList = ref([
  { id: 1, title: '城前村2025年第一季度村务公开', village: '城前村', type: '村务公开', publisher: '张建国', publishTime: '2025-05-05 10:00', views: 356, status: '已发布' },
  { id: 2, title: '城前村2025年基础设施建设项目公示', village: '城前村', type: '项目公示', publisher: '张建国', publishTime: '2025-05-10 14:30', views: 289, status: '已发布' },
  { id: 3, title: '前村2025年第一季度财务收支情况公开', village: '前村', type: '财务公开', publisher: '李志强', publishTime: '2025-05-08 09:20', views: 198, status: '已发布' },
  { id: 4, title: '后村2025年乡村振兴项目资金使用情况', village: '后村', type: '财务公开', publisher: '王伟', publishTime: '2025-05-12 11:10', views: 176, status: '已发布' },
  { id: 5, title: '东村2025年道路硬化工程施工公告', village: '东村', type: '项目公示', publisher: '赵云', publishTime: '2025-05-15 15:00', views: 210, status: '已发布' }
])
