...
const serviceCategories = [
  {
    title: '政务服务',
    description: '提供城前镇各类政务事项办理服务',
    icon: 'Document'
  },
  {
    title: '便民服务',
    description: '提供城前镇居民日常生活便民服务',
    icon: 'House'
  },
  {
    title: '农业服务',
    description: '提供农业技术指导和服务',
    icon: 'Plant'
  },
  {
    title: '医疗服务',
    description: '提供城前镇医疗健康服务',
    icon: 'FirstAidKit'
  }
]
...
// 热门服务
const hotServices = [
  { name: '农业补贴查询', icon: 'Money' },
  { name: '农村医保查询', icon: 'User' },
  { name: '宅基地办理', icon: 'House' },
  { name: '婚姻登记', icon: 'User' },
  { name: '农业技术指导', icon: 'Plant' },
  { name: '农村教育服务', icon: 'School' },
  { name: '就业服务', icon: 'OfficeBuilding' },
  { name: '农村养老服务', icon: 'User' }
]
