<template>
    <div class="dashboard-container">
      <div class="dashboard-header">
        <h1 class="dashboard-title">邹城市城前镇智慧乡镇管理平台</h1>
        <p class="dashboard-subtitle">打造智慧城前，服务美好生活</p>
      </div>
  ...
  const systemList = ref([
    { id: 1, systemName: '城前镇政务服务平台', owner: '王晓强', status: '运行中', updateTime: '2024-03-15 09:00', usage: 78, type: 'public' },
    { id: 2, systemName: '城前镇村务管理系统', owner: '李文娜', status: '运行中', updateTime: '2024-03-15 08:30', usage: 65, type: 'village' },
    { id: 3, systemName: '城前镇农业信息化平台', owner: '刘志洋', status: '运行中', updateTime: '2024-03-15 17:00', usage: 42, type: 'agriculture' },
    { id: 4, systemName: '城前镇应急指挥系统', owner: '张丽敏', status: '运行中', updateTime: '2024-03-15 16:00', usage: 30, type: 'emergency' }
  ])
  
  // 告警列表
  const alarmList = ref([
    { type: 'warning', time: '2024-03-15 10:30', content: '城前镇农业信息化平台存储空间使用率超过70%' },
    { type: 'info', time: '2024-03-15 09:15', content: '城前镇政务服务平台例行维护完成' },
    { type: 'success', time: '2024-03-15 08:00', content: '城前镇村务管理系统数据备份任务完成' }
  ])
